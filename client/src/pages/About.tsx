        ...
        >
          <div className="terminal-identity">
            ...
            <div className="terminal-identity__copy">
              ...
              <p>{text({ zh: "依托独特的“首尔协作”机制，企业将国际设计前沿与国内优势集群无缝对接。在此基础上全面融入数字化概念，通过可视化跟单与系统化协同提升全链路透明度。凭借业内领先的“小单快反”柔性供应链体系，实现100件起订、15-20天极速交付，大幅降低客户资金风险，为全球服装品牌提供高效、敏捷的跨国供应链全面解决方案。", en: "Through its distinctive ‘Seoul collaboration’ model, the company seamlessly connects international design insights with China’s strong production clusters. It also embeds digital practices throughout the operation, improving end-to-end transparency through visual order tracking and systematic coordination. Backed by an industry-leading flexible supply chain for small-batch, rapid-response production, it supports orders from 100 pieces and accelerated delivery in 15–20 days, substantially reducing clients’ capital exposure and providing global fashion brands with efficient, agile, end-to-end cross-border supply-chain solutions.", ko: "독자적인 ‘서울 협업’ 체계를 기반으로 국제 디자인 트렌드와 중국 내 우수 생산 클러스터를 유기적으로 연결합니다. 이를 토대로 디지털 개념을 전 과정에 도입하고, 시각화된 오더 추적과 체계적인 협업을 통해 공급망 전체의 투명성을 높입니다. 업계 선도 수준의 ‘소량·신속 대응’ 유연 공급망으로 100장부터 주문을 지원하고 15–20일의 빠른 납품을 실현해 고객의 자금 리스크를 크게 낮추며, 글로벌 패션 브랜드에 효율적이고 민첩한 종합 크로스보더 공급망 솔루션을 제공합니다." })}</p>
            </div>
          </div>
        </TerminalSection>
